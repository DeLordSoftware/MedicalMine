...
public class UtlityClass {
    final public static String strFxmlWelcome = "/FxmlDisplays/WelcomeSelectDisplay.fxml";
    final public static String strFxmlCategory = "/FxmlDisplays/CreateCategorysDisplay.fxml"; 
